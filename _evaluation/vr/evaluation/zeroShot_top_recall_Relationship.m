...
num_imgs=1000;
for i=1:num_imgs    
%     if ~isempty(tuple_labels_cell{i})
%         spatial_labels=[41,36,49,42,50,51,53,60,67,59,65,66,27,68,58,37,55,13,7,54,61,56,64,35,12,5,34,17,69,4,62,11,6,38,16,57,43,39,20,25,8,21,19,44,1]+1;
%         spatial_idx = ~ismember(tuple_labels_cell{i}(:,2),spatial_labels);
%         tuple_labels_cell{i}=tuple_labels_cell{i}(spatial_idx,:);
%         tuple_confs_cell{i} = tuple_confs_cell{i}(spatial_idx);       
%         
%         obj_bboxes_cell{i} = obj_bboxes_cell{i}(spatial_idx,:);
%         sub_bboxes_cell{i} = sub_bboxes_cell{i}(spatial_idx,:);
%     end
%     
