...
class ICCVDataLayerSemCached(caffe.Layer):
    ...
    def get_minibatch(self):
        ...
        conv_new_1 = self.cache['train/%s/conv_new_1'%imid][...]
        ...
        labels = np.zeros((gt['rlp_labels'].shape[0],70))
        #labels[:,gt['rlp_labels'][:1]]=1
    ...
    def setup(self, bottom, top):
        ...
        top[idx].reshape(cfg.TRAIN.IMS_PER_BATCH, 1024,
                         50,50)
        self._name_to_top_map['rfcn_cls'] = idx
        idx += 1
