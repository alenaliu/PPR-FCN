...
class ICCVDataLayerContextCached(caffe.Layer):
    ...
    def get_minibatch(self):
        ...
        if imid not in self.cache_mem:
            self.cache_mem[imid] = self.cache['train/%s/conv5_3'%imid][...]
        blobs['conv5_3']=self.cache_mem[imid]
    ...
    def setup(self, bottom, top):
        ...
        self.cache = h5py.File('output/precalc/sg_vrd_cache_vgg.h5','r')
        self.cache_mem = {}
        ...
        idx = 0
        top[idx].reshape(cfg.TRAIN.IMS_PER_BATCH, 512,
                         50,50)
    ...
    def forward(self, bottom, top):
        ...
        top[0].reshape(*blobs['conv5_3'].shape)
        top[0].data[...] = blobs['conv5_3']
