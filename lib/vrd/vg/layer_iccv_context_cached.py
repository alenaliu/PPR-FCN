...
class ICCVDataLayerContextCached(caffe.Layer):
    ...
    def get_minibatch(self):
        ...
        blobs['conv_new_1']= self.cache['train/%s/conv_new_1'%imid][...]#self.cache_mem[imid]
    ...
    def setup(self, bottom, top):
        ...
        self._cur_idx = 0
        self.gt_labels = {}
        self.meta = h5py.File('data/vg1_2_meta.h5', 'r')
        self.cache = h5py.File('output/vg_cache.h5','r')
        self.cache_mem = {}
        if os.path.exists('output/cache/vg_gt.pkl'):
            self.gt_labels = zl.load('output/cache/vg_gt.pkl')
            ...
            zl.save('output/cache/vg_gt.pkl',self.gt_labels)
