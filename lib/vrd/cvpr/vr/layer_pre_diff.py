...
class RelationDatalayer(caffe.Layer):
    def get_minibatch(self):
        ...
        while cnt < self._batch_size:
            ...
            visual_s.append(self.vgg_data[im_id+'/sub_visual'][r_idx])
            visual_o.append(self.vgg_data[im_id+'/obj_visual'][r_idx])
    ...
    def setup(self, bottom, top):
        ...
        top[1].reshape(self._batch_size, 4096)
        # to[1].reshape(self._batch_size, 4)
        top[2].reshape(self._batch_size)
        # self._name_to_top_map['visual'] = 0
        # self._name_to_top_map['classeme'] = 0
        self._name_to_top_map['visual_s'] = 0
        self._name_to_top_map['visual_o'] = 1
