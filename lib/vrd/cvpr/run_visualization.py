...
def run_relation_visualization():
    ...
    h5f_ours = h5py.File('output/sg_vrd_2016_result_diff_all_4500.hdf5')
    #h5f= h5py.File('output/sg_vrd_2016_result_pre_jointbox_15000.hdf5')
    #h5f= h5py.File('output/sg_vrd_2016_result_pre_concat_14000.hdf5')
    ...
    for imid in imids:
        ...
        # inds = range(0,len(obj_boxes_ours))
        # obj_boxes_ours = obj_boxes_ours[inds]
        # sub_boxes_ours = sub_boxes_ours[inds]
        # rlp_confs_ours = rlp_confs_ours[inds]
        # inds = np.where(rlp_confs_ours>thresh)
        # obj_boxes_ours = obj_boxes_ours[inds]
        # sub_boxes_ours = sub_boxes_ours[inds]
        # rlp_confs_ours = rlp_confs_ours[inds]
        ...
        cv2.createTrackbar('idx_lu','ctrl',0,rlp_confs_lu.shape[0]-1,nothing)
        cv2.createTrackbar('idx_lu_p','ctrl',0,len(lu_indices['p'])-1,nothing)
        cv2.createTrackbar('idx_lu_c','ctrl',0,len(lu_indices['c'])-1,nothing)
        cv2.createTrackbar('idx_lu_v','ctrl',0,len(lu_indices['v'])-1,nothing)
        cv2.createTrackbar('idx_lu_s','ctrl',0,len(lu_indices['s'])-1,nothing)

        cv2.createTrackbar('idx_ours','ctrl',0,rlp_confs_ours.shape[0]-1,nothing)
        cv2.createTrackbar('idx_ours_p','ctrl',0,len(ours_indices['p'])-1,nothing)
        cv2.createTrackbar('idx_ours_c','ctrl',0,len(ours_indices['c'])-1,nothing)
        cv2.createTrackbar('idx_ours_v','ctrl',0,len(ours_indices['v'])-1,nothing)
        cv2.createTrackbar('idx_ours_s','ctrl',0,len(ours_indices['s'])-1,nothing)
        ...
        while True:
            ...
            #start lu
            idx_lu_p = cv2.getTrackbarPos('idx_lu_p','ctrl')
            idx_lu = lu_indices['p'][idx_lu_p]
            im_lu_p = im_orig.copy()
            s_box_lu = sub_boxes_lu[idx_lu]
            o_box_lu = obj_boxes_lu[idx_lu]
            conf =  rlp_confs_lu[idx_lu]
            sub_label_lu = m['meta/cls/idx2name/'+str(rlp_labels_lu[idx_lu][0])][...]
            ...
            pre_label_lu = m['meta/pre/idx2name/'+str(rlp_labels_lu[idx_lu][1])][...]
            r_label_lu = '%s %s %s'%(sub_label_lu,pre_label_lu,obj_label_lu)
            cv2.putText(im_lu_p,r_label_lu,(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2)
            cv2.rectangle(im_lu_p,(s_box_lu[0],s_box_lu[1]),(s_box_lu[2],s_box_lu[3]),(0,200,0),2)
            cv2.rectangle(im_lu_p,(o_box_lu[0],o_box_lu[1]),(o_box_lu[2],o_box_lu[3]),(0,0,200),2)

            idx_lu_v = cv2.getTrackbarPos('idx_lu_v','ctrl')
            idx_lu = lu_indices['v'][idx_lu_v]
            im_lu_v = im_orig.copy()
            s_box_lu = sub_boxes_lu[idx_lu]
            o_box_lu = obj_boxes_lu[idx_lu]
            conf =  rlp_confs_lu[idx_lu]
            sub_label_lu = m['meta/cls/idx2name/'+str(rlp_labels_lu[idx_lu][0])][...]
            ...
            pre_label_lu = m['meta/pre/idx2name/'+str(rlp_labels_lu[idx_lu][1])][...]
            r_label_lu = '%s %s %s'%(sub_label_lu,pre_label_lu,obj_label_lu)
            cv2.putText(im_lu_v,r_label_lu,(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2)
            cv2.rectangle(im_lu_v,(s_box_lu[0],s_box_lu[1]),(s_box_lu[2],s_box_lu[3]),(0,200,0),2)
            cv2.rectangle(im_lu_v,(o_box_lu[0],o_box_lu[1]),(o_box_lu[2],o_box_lu[3]),(0,0,200),2)

            idx_lu_c = cv2.getTrackbarPos('idx_lu_c','ctrl')
            idx_lu = lu_indices['c'][idx_lu_c]
            im_lu_c = im_orig.copy()
            s_box_lu = sub_boxes_lu[idx_lu]
            o_box_lu = obj_boxes_lu[idx_lu]
            conf =  rlp_confs_lu[idx_lu]
            sub_label_lu = m['meta/cls/idx2name/'+str(rlp_labels_lu[idx_lu][0])][...]
            ...
            pre_label_lu = m['meta/pre/idx2name/'+str(rlp_labels_lu[idx_lu][1])][...]
            r_label_lu = '%s %s %s'%(sub_label_lu,pre_label_lu,obj_label_lu)
            cv2.putText(im_lu_c,r_label_lu,(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2)
            cv2.rectangle(im_lu_c,(s_box_lu[0],s_box_lu[1]),(s_box_lu[2],s_box_lu[3]),(0,200,0),2)
            cv2.rectangle(im_lu_c,(o_box_lu[0],o_box_lu[1]),(o_box_lu[2],o_box_lu[3]),(0,0,200),2)

            idx_lu_s = cv2.getTrackbarPos('idx_lu_s','ctrl')
            idx_lu = lu_indices['s'][idx_lu_s]
            im_lu_s = im_orig.copy()
            s_box_lu = sub_boxes_lu[idx_lu]
            o_box_lu = obj_boxes_lu[idx_lu]
            conf =  rlp_confs_lu[idx_lu]
            sub_label_lu = m['meta/cls/idx2name/'+str(rlp_labels_lu[idx_lu][0])][...]
            ...
            pre_label_lu = m['meta/pre/idx2name/'+str(rlp_labels_lu[idx_lu][1])][...]
            r_label_lu = '%s %s %s'%(sub_label_lu,pre_label_lu,obj_label_lu)
            cv2.putText(im_lu_s,r_label_lu,(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2)
            cv2.rectangle(im_lu_s,(s_box_lu[0],s_box_lu[1]),(s_box_lu[2],s_box_lu[3]),(0,200,0),2)
            cv2.rectangle(im_lu_s,(o_box_lu[0],o_box_lu[1]),(o_box_lu[2],o_box_lu[3]),(0,0,200),2)
            ...
            cv2.imshow('im_lu_s',im_lu_s)
            cv2.imshow('im_lu_p',im_lu_p)
            cv2.imshow('im_lu_v',im_lu_v)
            cv2.imshow('im_lu_c',im_lu_c)
    ...
    for imid in imids:
        ...
        while True:
            ...
            if c == ord('s'):
                ...
                if lu_len>=0:cv2.imwrite('output/results/examples/'+imid+'/lu_'+imid+str(idx_ours)+'.jpg',im_lu)
