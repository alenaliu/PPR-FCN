#ifndef CAFFE_BINARY_LOG_LOSS_LAYER_HPP_
#define CAFFE_BINARY_LOG_LOSS_LAYER_HPP_
...
class BinaryLogLossLayer : public LossLayer<Dtype> {
 public:
  explicit BinaryLogLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BinaryLogLoss"; }

 protected:
  /// @copydoc BinaryLogLossLayer
