 ...
 * @param param provides PSROIContextPoolingParameter psroi_pooling_param,
 *        with PSROIContextPoolingLayer options:
...
class PSROIContextPoolingLayer : public Layer<Dtype> {
 public:
  explicit PSROIContextPoolingLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PSROIContextPooling"; }
